...
function importElement(href) {
  return function (dispatch, getState) {
    ...
    var imports = _getState._imports;
    var link = void 0;
...
function formatAndRun(_ref) {
  ...
  var endpoint = dataEndpoint + '/' + encodeURIComponent(uid),
...
var _generateRequestActio2 = slicedToArray(_generateRequestActio, 3);
...
var _generateRequestActio4 = slicedToArray(_generateRequestActio3, 3);

var setData$1 = _generateRequestActio4[0];
var setDataSuccessful$1 = _generateRequestActio4[1];
var setDataFailed$1 = _generateRequestActio4[2];
...
var _generateRequestActio6 = slicedToArray(_generateRequestActio5, 3);
...
var get$3 = generateHandler('get', [getData$1, getDataSuccessful$1, getDataFailed]);
var set$3 = generateHandler('put', [setData$1, setDataSuccessful$1, setDataFailed$1]);
var remove$2 = generateHandler('delete', [removeData$1, removeDataSuccessful$1, removeDataFailed]);
  ...
  return function (dispatch, getState) {
    ...
    if (typeof stored === 'undefined') {
      fetchData = runDispatchAndExpect(dispatch, get$3(uid), GET_DATA_FROM_API_SUCCESSFUL).then(function (response) {
        return runDispatchAndExpect(dispatch, set$2(uid, response, false), SET_DATA_SUCCESSFUL);
      });
    } else {
...
function set$2(uid, data) {
  var validate = arguments.length <= 2 || arguments[2] === undefined ? true : arguments[2];
  ...
  return function (dispatch, getState) {
    ...
    if (validate && !dataIsValid(data)) {
      ...
      action = setDataSuccessful$$1(uid, data);
    }
...
function remove$1(uid, data) {
  return function (dispatch, getState) {
    dispatch(removeData$$1(uid));

    return Promise.resolve().then(function () {
      return dispatch(removeDataSuccessful$$1(uid));
    });
  };
}
...
function hashTracking(Simpla) {
  ...
  Simpla.observeState('config.hashTracking', function (shouldTrack) {
    if (shouldTrack) {
      startTracking();
    } else {
      stopTracking();
  ...
  function run() {
    ...
    if (!stillInSession()) {
      if (!checkAndPing(Simpla.getState().config)) {
        (function () {
          var unobserve = Simpla.observeState('config', function (config) {
...
function imports() {
  ...
  switch (action.type) {
    ...
    case IMPORT_ELEMENT_FAILED:
    case IMPORT_ELEMENT_SUCCESSFUL:
      return Object.assign({}, state, defineProperty$1({}, action.href, singleImportReducer(state[action.href], action)));
    default:
      return state;
  }
}
...
function save$2() {
  ...
  if (action.hasOwnProperty('uid')) {
    ...
    if (newUidState !== currentUidState) {
      return Object.assign({}, state, defineProperty$1({}, uid, newUidState));
    }
  }
...
Object.assign(Simpla, {
  ...
  login: function login() {
    return dispatchThunkAndExpect(store, login$1.apply(undefined, arguments), LOGIN_SUCCESSFUL);
  },
  logout: function logout() {
    return dispatchThunkAndExpect(store, logout$1.apply(undefined, arguments), LOGOUT_SUCCESSFUL);
  },


  // Data
  get: function get() {
    return dispatchThunkAndExpect(store, get$2.apply(undefined, arguments), GET_DATA_SUCCESSFUL);
  },
  set: function set() {
    return dispatchThunkAndExpect(store, set$2.apply(undefined, arguments), SET_DATA_SUCCESSFUL);
  },
  remove: function remove() {
    return dispatchThunkAndExpect(store, remove$1.apply(undefined, arguments), REMOVE_DATA_SUCCESSFUL);
  },
  save: function save() {
    return dispatchThunkAndExpect(store, save$1.apply(undefined, arguments), SAVE_SUCCESSFUL);
  },
  observe: function observe() {
    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
  ...
  observeState: function observeState() {
...
//# sourceMappingURL=data:application/json;base64,
